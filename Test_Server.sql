...
-- Inserting records into the Citizen_Info table for Dhaka
...
('CIT003', 'Shahriar Kabir', 'House 24, Road 8, Dhanmondi, Dhaka', '01912345670', 'shahriar.kabir@hotmail.com', 'Male', '1990-08-26', '1978014530987', DEFAULT),
...
('CIT007', 'Khaled Mahmud', 'House 22, Bashundhara R/A, Block F, Dhaka', '01899887766', 'khaled.mahmud@hotmail.com', 'Male', '1985-12-16', '1988012567894', DEFAULT),
...
('CIT011', 'Nur Ibne Kawsar Zitu', 'House 226, Road 5, Block C, Bashundhara R/A', '01712345670', 'nur.zitu@gmail.com', 'Male', '2000-11-15', '1990045530425', DEFAULT), -- Fixed Contact_Number and Email
...
('CIT013', 'Sayed Mahi Ashrafi', 'House 26, Road 2, Block D, Nikunja R/A', '01798765432', 'syed.mahi@gmail.com', 'Male', '2001-09-17', '1990067530124', DEFAULT), -- Corrected Email
...
(9, 'Hasnat Islam', 105, 'Officer', '01316619278', 'hasnat.islam@citygov.org', 7, 'Bachelor’s in Transportation Management', 'House 526, Road 17, Block J, Bashundhara R/A', 8),
(10, 'Md. Minhajul Islam', 106, 'Department Head', '01756619289', 'minhajul.islam@citygov.org', 22, 'PhD in Infrastructure Development', 'House 257, Road 5, Block C, Bashundhara R/A',8);
...
(110, 'Technology and Innovation', NULL, 65000000, 40, 'Develop and manage city tech infrastructure and smart city initiatives.', '9:00 AM - 6:00 PM');

-- Updating Depaetment Head for testing and debugging purposes
UPDATE Department
SET Head_Official_ID = 9
WHERE Department_Name = 'Technology and Innovation';
...
CREATE TABLE Location (
    ...
    Location_Type VARCHAR(50) CHECK (Location_Type IN ('Residential', 'Commercial', 'Industrial', 'Heritage', 'Mixed-Use')), -- Type of area
...
-- drop table location;
-- Assuming Citizen_Info and Location tables are already populated
INSERT INTO Citizen_Location (Citizen_ID, Location_ID)
VALUES
    ('CIT001', 1), -- Citizen 1 is associated with Location 1 (e.g., Gulshan 1)
    ('CIT002', 3), -- Citizen 2 is associated with Location 2 (e.g., Gulshan 2)
    ('CIT003', 4), -- Citizen 3 is associated with Location 3 (e.g., Banani)
    ('CIT004', 7), -- Citizen 4 is associated with Location 4 (e.g., Dhanmondi 27)
    ('CIT005', 9), -- Citizen 5 is associated with Location 5 (e.g., Mirpur 10)
    ('CIT006', 5), -- Citizen 6 is associated with Location 6 (e.g., Bashundhara Residential Area)
    ('CIT007', 6), -- Citizen 7 is associated with Location 7 (e.g., Uttara Sector 4)
    ('CIT008', 8), -- Citizen 8 is associated with Location 8 (e.g., Farmgate)
    ('CIT009', 6), -- Citizen 9 is associated with Location 9 (e.g., Shyamoli)
    ('CIT010', 6), -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
	('CIT011', 6), -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
    ('CIT012', 6), -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
    ('CIT013', 6), -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
    ('CIT014', 6), -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
    ('CIT015', 6); -- Citizen 10 is associated with Location 10 (e.g., Old Dhaka)
-- Testing Purpose
...
-- FROM Weather_Condition_Data w,location l
...
drop table infrastructure_maintenance;
...
-- drop table Metro_Transportation ;
...
-- select l.Location_Name,m.Contractor_Name,m.Maintenance_ID,m.Status
-- from location l, infrastructure_maintenance m
